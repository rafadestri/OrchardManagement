...
namespace OrchardManagement.Controllers
{
    public class SpeciesController : Controller
    {
        ...
        public SpeciesController(OrchardContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Description")] Species species)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description")] Species species)
        {
            if (id != species.ID)
            {
                return NotFound();
